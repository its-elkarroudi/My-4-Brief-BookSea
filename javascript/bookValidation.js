...
const checkDescriptions = (description) => {
...
addBookForm.addEventListener("submit", (event) =>{
    ...
    if(bookTitle.value.trim() === ""){
     ...
     else if(checkTitle(bookTitle.value)){
     ...
     else if(checkTitle(bookAuthor.value)){
     ...
     else if(checkDescriptions(bookDescription.value)){
