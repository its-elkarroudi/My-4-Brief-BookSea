...
nextButton.addEventListener("click", function () {
    if (currentIndex < categoryContainer.children.length - 1) {
        ...
        currentIndex = 0; // Reset to the first category when at the end.
        updateCarousel();
    }
});
...
prevButton.addEventListener("click", function () {
    if (currentIndex > 0) {
        ...
        currentIndex = categoryContainer.children.length - 1; // Reset to the last category when at the beginning.
        updateCarousel();
    }
});
